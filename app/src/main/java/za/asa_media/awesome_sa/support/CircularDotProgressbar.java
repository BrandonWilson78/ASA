...
public class CircularDotProgressbar extends View {

    // Normal dot radius
    private int dotRadius = 9;

    // Expanded Dot Radius
    private int bounceDotRadius = 15;
    ...
    public CircularDotProgressbar(Context context) {
        super(context);
    }

    public CircularDotProgressbar(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CircularDotProgressbar(Context context, AttributeSet attrs, int defStyleAttr) {
