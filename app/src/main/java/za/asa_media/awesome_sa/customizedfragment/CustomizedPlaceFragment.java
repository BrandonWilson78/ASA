package za.asa_media.awesome_sa.customizedfragment;
...
public class CustomizedPlaceFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater var1, ViewGroup var2, Bundle var3) {
        ...
        this.zzbnl = var4.findViewById(id.place_autocomplete_search_button);
        this.zzbnm = var4.findViewById(id.place_autocomplete_clear_button);
        this.zzbnn = var4.findViewById(id.place_autocomplete_search_input);
        this.zzbnn.setHint("Search Your Business");
    ...
    public void setHint(CharSequence var1) {
        this.zzbnn.setHint("Search your buisness here");
        this.zzbnl.setContentDescription("Search Your buisness here");
    }
    ...
    public void zzJk() {
        ...
        try {
            Intent var2 = (new PlaceAutocomplete.IntentBuilder(2)).setBoundsBias(this.zzbnp).setFilter(this.zzbnq).zzeZ(this.zzbnn.getText().toString()).zzlc(1).build(this.getActivity());
            this.zzbno = true;
