...
public class CreateAdNews extends AppCompatActivity implements View.OnClickListener, IAdsImageCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_ad_news);
    ...
    private void initViews() {
        ...
        myCustomPagerAdapter = new PagerAdapterAdNewsImages(mContext, new String[]{"", "", ""}, images, 1);
    ...
    private void skipCallback() {
        InitialValueSetUp.mBatchs = ArrayUtils.removeElement(batchs, "5");
