...
public class CreateAdPromotions extends AppCompatActivity implements View.OnClickListener, IAdsImageCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_ad_promotions);
    ...
    private void initViews() {
        ...
        myCustomPagerAdapter = new PagerAdapterAdPromotionImages(mContext, new String[]{"", "", ""}, images, 1);
        ...
        try {
            ...
            if (batchs != null) {
                ...
                CreateAdPromotions.this.finish();
...
*/
    ...
    private void skipCallback() {
        InitialValueSetUp.mBatchs = ArrayUtils.removeElement(batchs, "3");
