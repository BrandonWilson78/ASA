...
import za.asa_media.awesome_sa.modules_.registered_users.adapter.AdapterThree;
...
public class FragmentThreeReg extends Fragment {
    ...
    private void init(View v) {
        ...
        mdap = new AdapterThree(getActivity(), mListData);
