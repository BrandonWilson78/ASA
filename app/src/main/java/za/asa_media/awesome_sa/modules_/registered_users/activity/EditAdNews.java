...
import za.asa_media.awesome_sa.modules_.registered_users.adapter.PagerAdapterAdNewsImages;
...
public class EditAdNews extends AppCompatActivity implements View.OnClickListener, IAdsImageCallback {
    ...
    private int images[] = {R.drawable.img_news, R.drawable.img_news, R.drawable.img_news};
    private PagerAdapterAdNewsImages myCustomPagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_ad_news);
                            ...
                            if (response.optBoolean("status")) {
                                if (response.has("data")) {
                                    ...
                                    if (jArray != null) {
                                        ...
                                        int images[] = {R.drawable.img_news, R.drawable.img_news, R.drawable.img_news};
                                        String imagesS[] = {image_path, image_path2, image_path3};
                                        myCustomPagerAdapter = new PagerAdapterAdNewsImages(mContext, imagesS, images, 2);
