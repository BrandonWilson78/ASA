...
import za.asa_media.awesome_sa.modules_.registered_users.adapter.AdapterTwo;
...
public class FragmentTwoReg extends Fragment {
 ...
 //   private EditText mEditTextSearch;
    ...
    private void init(View v) {
     ...
     //   mEditTextSearch = (EditText) getActivity().findViewById(R.id.edittext_search);
        ...
        mdap = new AdapterTwo(getActivity(), mListData);
    ...
    private String[] getNearByPlacesNames() {
        String[] nameSet = {"Art & Crafts", "Events & Concerts", "Retail therapy",
