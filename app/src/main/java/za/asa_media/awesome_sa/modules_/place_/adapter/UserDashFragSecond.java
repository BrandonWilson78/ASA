...
public class UserDashFragSecond extends RecyclerView.Adapter<UserDashFragSecond.MyViewHolder> {
    ...
    public UserDashFragSecond(Activity mContext, List<NearByPlacesData> mListData) {
