...
public class AdapterAdUnderReview extends RecyclerView.Adapter<AdapterAdUnderReview.CustomViewHolder> {

    private UiHandleMethods uihandle;
    private List<UnderReviewAdModel> feedItemList;
    private Activity mContext;
    private View view;


    public AdapterAdUnderReview(Activity context, List<UnderReviewAdModel> feedItemList) {
    ...
    public void onBindViewHolder(CustomViewHolder customViewHolder, final int i) {
        UnderReviewAdModel feedItem = feedItemList.get(i);
    ...
    public void addItem(UnderReviewAdModel data) {
        feedItemList.add(data);
        notifyItemInserted(feedItemList.size());
    }

    public void replaceItem(final UnderReviewAdModel newItem, final int position) {
