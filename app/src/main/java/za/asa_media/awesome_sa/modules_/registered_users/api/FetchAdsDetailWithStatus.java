...
/**
 * Created by Snow-Dell-05 on 5/29/2017.
 */

public class FetchAdsDetailWithStatus extends AsyncTask<String, Void, JSONObject> {
    ...
    public FetchAdsDetailWithStatus(Activity context) {
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        uihandle.startProgress("While ads are being fetched...");
