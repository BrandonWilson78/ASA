...
public class EditAdSpecial extends AppCompatActivity implements View.OnClickListener, IAdsImageCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_ad_special);
                            ...
                            if (response.optBoolean("status")) {
                                if (response.has("data")) {
                                    ...
                                    if (jArray != null) {
                                        ...
                                        int images[] = {R.drawable.img_specials, R.drawable.img_specials, R.drawable.img_specials};
                                        String imagesS[] = {image_path, image_path2, image_path3};

                                        myCustomPagerAdapter = new MyCustomPagerAdapter(mContext, imagesS, images, 2);
