...
public class UserDashFragFirst extends RecyclerView.Adapter<UserDashFragFirst.MyViewHolder> {
...
//    private int[] icons_id;
    ...
    public UserDashFragFirst(Activity mContext, List<NearByPlacesData> mListData) {
