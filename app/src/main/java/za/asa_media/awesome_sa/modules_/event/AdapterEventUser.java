...
public class AdapterEventUser extends PagerAdapter {
    ...
    public AdapterEventUser(Activity context, String netImages[]) {
    ...
    public void setImage(String image_path, ImageView mBatchImage) {
        if (!TextUtils.isEmpty(image_path)) {
            Picasso.with(context).load(image_path).error(R.drawable.event_banner)
                    .placeholder(R.drawable.event_banner)
                    .skipMemoryCache()
                    .into(mBatchImage);
