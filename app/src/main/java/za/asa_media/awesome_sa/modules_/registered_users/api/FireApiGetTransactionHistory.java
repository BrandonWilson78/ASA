...
public class FireApiGetTransactionHistory extends AsyncTask<String, Void, JSONObject> {
    ...
    public FireApiGetTransactionHistory(Activity context) {
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        uihandle.startProgress("While transaction is being loaded...");
