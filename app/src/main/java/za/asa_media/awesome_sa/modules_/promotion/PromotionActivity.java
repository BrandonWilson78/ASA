...
public class PromotionActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private AdapterPromotionUser mAdapterPromotion;
    ...
    private void initViews() {
        ...
        mTextViewSpecialVoucher = (TextView) findViewById(R.id.txt_coupan_);
                            ...
                            if (response.optBoolean("status")) {
                                if (response.has("data")) {
                                    ...
                                    if (jArray != null) {
                                        ...
                                        mTextViewSpecialName.setText("Promotion Name: " + name);
                                        ...
                                        mAdapterPromotion = new AdapterPromotionUser(mContext, imagesS);
                                        mViewPager.setAdapter(mAdapterPromotion);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.img_footer_back:
                ...
                startActivity(new Intent(mContext, EventsActivity.class));
                this.finish();
                overridePendingTransition(R.anim.pull_in_left, R.anim.push_out_right);
                break;
            case R.id.img_footer_forword:
                uihandle.explicitIntent(NewsActivity.class);
                this.finish();
                break;
