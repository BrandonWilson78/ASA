...
public class NewsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private AdapterNewsUser mAdapterNews;
                            ...
                            if (response.optBoolean("status")) {
                                if (response.has("data")) {
                                    ...
                                    if (jArray != null) {
                                        ...
                                        mTextViewSpecialName.setText("News Name: " + name);
...
//                                        mTextViewSpecialDecription.setText(jObj.optString("description"));
                                        ...
                                        mAdapterNews = new AdapterNewsUser(mContext, imagesS);
                                        mViewPager.setAdapter(mAdapterNews);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.img_footer_back:
                ...
                startActivity(new Intent(mContext, PromotionActivity.class));
                this.finish();
                overridePendingTransition(R.anim.pull_in_left, R.anim.push_out_right);
                break;
