...
public class EditAdEvent extends AppCompatActivity implements View.OnClickListener, IAdsImageCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_ad_event);
    ...
    private void initViews() {
        ...
        // pger setup for three images to be uploaded
        ...
        mEditTextEventStartTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mTimePicker = new TimePickerDialog(EditAdEvent.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
                            ...
                            if (response.optBoolean("status")) {
                                if (response.has("data")) {
                                    ...
                                    if (jArray != null) {
                                        ...
                                        mEditTextEventStartTime.setText("" + jObj.optString("EventTime"));
                                        mEditTextLocationName.setText("" + jObj.optString("EventLocation"));
                                        ...
                                        int images[] = {R.drawable.img_event, R.drawable.img_event, R.drawable.img_event};
                                        String imagesS[] = {image_path, image_path2, image_path3};

                                        myCustomPagerAdapter = new PagerAdapterAdEventImages(mContext, imagesS, images, 2);
    ...
    private void goForCreateAd() {
        ...
        }.execute(URLListApis.URL_EDIT_ADS, adName, description, startDate, endDate, "N/A", email, website, landline, mobile, locationName, eventStartTime);
